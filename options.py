...
flags.DEFINE_string('embedding_path',PREFIX + 'data/embs_bert_1024', "path for embedding")
flags.DEFINE_integer('batch_size',200, "batch size")
flags.DEFINE_integer('vocab_size', 0, "size of vocabulary")
flags.DEFINE_integer('dim_h', 1024, "dimension of encoder hidden state")
flags.DEFINE_integer('dim_e', 1024, "dimension of embedding")
