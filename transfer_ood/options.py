...
PREFIX = ""
dataset=['yelp','amazon']
flags.DEFINE_string('train_path',PREFIX + 'data/', "path for training dataset")
flags.DEFINE_string('dev_path',PREFIX + 'data/', "path for validation dataset")
flags.DEFINE_string('test_path',PREFIX + 'data/'+dataset[0]+'/test', "path for test dataset")
...
flags.DEFINE_string('embedding_path',PREFIX + 'data/embs_300_out_allvocab_amazon1', "path for embedding")
flags.DEFINE_integer('dim_h', 300, "dimension of encoder hidden state")
flags.DEFINE_integer('dim_e', 300, "dimension of embedding")
flags.DEFINE_string('eval_embedding_path',PREFIX + 'data/embs_300_out_allvocab', "path for embedding of cnn classifier")
...
flags.DEFINE_string('summaries_dir', PREFIX + 'tensorboard', 'path for summary')
